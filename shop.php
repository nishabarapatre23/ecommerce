                ...
                <?php   
                    if(!isset($_GET['p_cat'])){
                        if(!isset($_GET['cat'])){
                            echo "<div class='box'>
                            <h1>Shop</h1>
                            <p>In the comfort of one's own space, the world of online shopping unfolds with a few clicks and taps. With a vast array of virtual stores at one's fingertips, the digital marketplace offers a treasure trove of possibilities.</p>
                            </div>";
                        }
                    }
                ?>
