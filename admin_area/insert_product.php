...
$product_desc=$_POST['product_descri'];
...
$insert_product="insert into product(p_cat_id,cat_id,date,product_title,
product_img1,product_img2,product_img3,product_price,
product_descri,product_keyword) values('$product_cat','$cat',NOW(),'$product_title',
