...
if(isset($_POST['submit'])){
    ...
    $insert_admin= "insert into admins (admin_name,admin_email,admin_pass,admin_country,admin_job,
    admin_contact,admin_about,admin_image) values ('$admin_name','$admin_email','$admin_pass','$admin_country',
    '$admin_job','$admin_contact',' $admin_about',' $admin_image')";

    $run_admin=mysqli_query($con,$insert_admin);

    if($insert_admin){
        echo "<script>alert('One user has been Inserted ')</script>";
        echo "<script>window.open('index.php?view_users')</script>";
